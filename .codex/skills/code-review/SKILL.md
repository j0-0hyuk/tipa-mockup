...
**Step 1 — Simplify**
`simplify` 스킬을 실행합니다. 코드 재사용성·품질·효율성 관점에서 추가 이슈를 찾아 직접 수정하고, 수정 요약을 리뷰 결과에 통합합니다.

**Step 2 — Security Review**
`security-review` 스킬을 실행합니다. 브랜치 변경 diff를 기준으로 보안 취약점을 심층 분석하고, 발견된 취약점을 리뷰 결과의 🔴 Critical / 🟡 Warning 항목에 병합합니다.
